...
// FROM jos_ierp_deliverychallan g
...
$sql = "
    ...
    LEFT JOIN jos_ierp_msupermaster sm
           ON sm.id = g.supplier
    WHERE g.id = ?
    LIMIT 1
";
...
FROM jos_ierp_deliverychallan_grid gg
...
<body>
    ...
    <div class="no-print" style="margin:10px;">
        ...
        <button class="btn btn-back" onclick="window.location.href='/reports/deliverychallanlist.php'">Back</button>
    </div>
    ...
    <div class="print-wrapper">
        ...
        <table class="table">
            <tr>
                <th style="font-size:14px">Delivery Challan </th>
            </tr>
        </table>
        ...
        <table style="width:100%; border-collapse:collapse; margin-top:8px;">
            <tr>
                ...
                <td width="33%" style="vertical-align:top; padding:6px;">
                    ...
                    <div><strong>Supplier :</strong> <?= h($hdr['supplier_name']) ?></div>
                ...
                <td width="33%" style="vertical-align:top; padding:6px;">
                    ...
                    <div><strong> Vehicle No. :</strong> <?= h($hdr['vehicle']) ?></div>
        ...
        <table class="table">
            <tr>
                ...
                <th width="8%">QTY</th>
                <th width="8%">UOM</th>
                <th width="8%">Actual Weight (KG)</th>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center"><?= h($it['actualweight']) ?></td>
