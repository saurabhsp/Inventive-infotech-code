...
foreach ($grid as $r) {
    ...
    $rowsHtml .= '<td class="r nowrap">' . money2($amt) . '</td>';
...
if ($showLoyalCol) {
    $theadHtml .= '
    <th>
        Additional Loyalty<br>
        ' . ($loyaltyPer ? '@'.$loyaltyPer.'%' : '') . '<br>
        Rs. Each
    </th>';
}
...
$totalsHtml .= '
    <td class="r b nowrap">'.h(money2($totalAmtLines ?: $subTotal)).'</td> <!-- Amount -->
</tr>';
;
