...
<input type="hidden" name="discountamt" id="discountamt" value="0">
  ...
  <div class="charge-fields">
    ...
    <input type="hidden" id="packing_gst_total" name="packing_gst_total" value="0">
...
// 1️⃣ BASE = BASIC TOTAL ka %
const packingPer = val('packing_per');      // % entered
const packingBase = (packingPer > 0)
  ? (basicTotal * packingPer / 100)
  : 0;

// 2️⃣ GST on PACKING AMOUNT
const packingGstPer = val('packing');       // GST %
const packingGstAmt = (packingGstPer > 0)
  ? (packingBase * packingGstPer / 100)
  : 0;

// 3️⃣ FINAL PACKING TOTAL
const packingTotal = packingBase + packingGstAmt;
const packingFinalTotal = packingTotal + basicWithGST;

// 4️⃣ SET VALUES (VERY IMPORTANT)
setv('packing_amt', packingBase);            // Amount field
setv('packing_total', packingFinalTotal);         // Total final field

// ✅ STORE GST-CONVERTED AMOUNT IN HIDDEN FIELD
document.getElementById('packing_gst_total').value =
