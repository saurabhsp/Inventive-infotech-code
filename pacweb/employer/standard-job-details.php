...
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">
    ...
    <!-- âœ… COPY CSS FROM jobdetails.html -->
 ...
 <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; }
        ...
        body { 
            ...
            color: var(--text-dark); 
            font-size: 15.5px; /* Base font size */
            line-height: 1.6; 
        }
        ...
        .nav-item { font-weight: 600; color: #555; font-size: 1rem; }
        .nav-item:hover { color: var(--primary); }
        .nav-right { display: flex; gap: 15px; align-items: center; }
        .login-link { font-weight: 700; color: var(--primary); }
        .btn-header-cta { background: var(--primary); color: white; padding: 8px 22px; border-radius: 30px; font-weight: 600; border: none; }
        ...
        .logo-box-standard { 
            width: 80px; height: 80px; flex-shrink: 0; display: flex; align-items: center; justify-content: center;
            border: 1px solid #eee; border-radius: 50%; padding: 5px;
        }
        .company-logo { width: 100%; height: 100%; border-radius: 50%; object-fit: contain; }

        .job-title-info h1 { font-size: 1.8rem; font-weight: 800; color: var(--text-dark); margin-bottom: 5px; line-height: 1.2; }
        .company-name { font-size: 1.1rem; color: var(--primary); font-weight: 600; display: block; }
        
        /* --- 4. SIDEBAR (Overview & Actions) --- */
        .job-sidebar { position: sticky; top: 90px; }

        .overview-grid { display: flex; flex-direction: column; gap: 15px; }

        /* Boxed Style for Stats */
        .stat-box {
            border: 1px solid var(--border-light); border-radius: 12px; padding: 15px;
            display: flex; align-items: center; gap: 15px; background: #fff;
        }
        .stat-icon { font-size: 1.2rem; color: var(--text-dark); }
        .stat-text { font-weight: 400; font-size: 1rem; color: var(--text-dark); }
        .stat-label { font-size: 0.85rem; color: #666; font-weight: bolder; margin-right: 5px; }

        .btn-apply-main {
            width: 100%; background: var(--primary); color: white; 
            padding: 15px; border-radius: 30px; font-weight: 700; font-size: 1.1rem; border: none;
            margin-top: 20px; box-shadow: 0 5px 15px rgba(72, 62, 168, 0.3); transition: 0.2s;
        }
        .btn-apply-main:hover { background: #322b7a; transform: translateY(-2px); }
        ...
        .req-list { list-style: none; padding-left: 5px; }
        .req-list li { position: relative; padding-left: 15px; margin-bottom: 8px; color: #444; font-size: 0.95rem; }
        .req-list li::before { content: 'â€¢'; position: absolute; left: 0; color: var(--text-dark); font-weight: bold; }

        /* Contact Details */
        .contact-section { margin-top: 20px; }
        .hr-name { font-weight: 700; color: var(--primary); font-size: 1.1rem; display: block; margin-bottom: 5px; }
        .hr-address { color: #444; font-size: 0.95rem; line-height: 1.5; margin-bottom: 20px; }

        /* Action Buttons Row */
        .contact-actions { display: flex; gap: 10px; margin-top: 15px; }
        .btn-action-outline {
            flex: 1; display: inline-flex; align-items: center; justify-content: center; gap: 8px;
            padding: 10px 15px; border: 1px solid var(--primary); border-radius: 30px;
            background: white; color: var(--primary); font-weight: 600; font-size: 0.95rem;
            transition: all 0.2s; cursor: pointer; white-space: nowrap;
        }
        .btn-action-outline:hover { background: var(--primary-light); transform: translateY(-2px); }

        /* Share Box */
        .share-box {
            background: #f0f7ff; border-radius: 12px; padding: 20px; margin-top: 30px;
            border: 1px solid #d0e4f7;
        }
        .share-title { font-weight: 700; color: #1976d2; margin-bottom: 5px; font-size: 1rem; }
        .share-desc { font-size: 0.9rem; color: #555; margin-bottom: 15px; }
        .btn-share {
            background: #1565c0; color: white; border: none; padding: 10px 25px; 
            border-radius: 30px; font-weight: 600; display: inline-flex; align-items: center; gap: 8px; font-size: 0.9rem;
        }
        .btn-share:hover { background: #0d47a1; }
    ...
    /* âœ… FIXED STICKY BUTTON */
    .btn-apply-main {
    position: fixed;
    bottom: 15px; /* ðŸ”¥ IMPORTANT */
    left: 10px;
    right: 10px;
    width: auto;
    ...
    border-radius: 30px; /* ðŸ”¥ modern look */
    z-index: 9999;
...
/* âœ… IMPORTANT: keep this OUTSIDE media */
body {
    padding-bottom: 90px;
}
@media (max-width: 900px) {
...
<script>      window.onload = () => document.getElementById("global-preloader")?.remove();</script>
</body>
</html>
