...
$job_listing_type = $_POST['job_listing_type'] ?? 2;
...
if (isset($_POST['call_action']) || isset($_POST['chat_action'])) {
    ...
    // print_r( $action_type);
    // exit;
    $mobile = preg_replace('/\D/', '', $job['mobile_no']); // remove all non-numeric
...
<i class="fas fa-comment-dots"></i> Chat
                            ...
                            <form method="POST" style="display:inline;">
                                <input type="hidden" name="job_id" value="<?= $job_id ?? 0 ?>">
                                <input type="hidden" name="job_listing_type" value="<?= $job_listing_type ?>">
                                <button type="submit" class="btn-action-outline" name="call_action" class="btn btn-outline">
                            ...
                            <form method="POST" style="display:inline;">
                                <input type="hidden" name="job_id" value="<?= $job_id ?? 0 ?>">
                                <input type="hidden" name="job_listing_type" value="<?= $job_listing_type ?>">
                                <button class="btn-action-outline" type="submit" name="chat_action" class="btn btn-outline">
                                    <i class="fas fa-comment-dots"></i> Chat
                                </button>
                            </form>
