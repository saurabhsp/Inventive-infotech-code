...
--unread-dot: #2563eb;
    ...
    padding: 0 20px;
        ...
        .noti-card:hover { border-color: var(--primary); transform: translateY(-2px); }

        /* Status Dot */
        .unread-indicator {
            position: absolute; top: 20px; right: 20px;
            width: 10px; height: 10px; background: var(--unread-dot);
            border-radius: 50%;
        }
        ...
        .icon-call { background: #f1f5f9; color: #333; }
        .icon-location { background: #fef2f2; color: var(--location-icon); }

        .noti-title { font-size: 1.05rem; font-weight: 700; color: var(--text-dark); }
        ...
        .noti-time { font-size: 0.8rem; color: #94a3b8; font-weight: 600; }
        .view-link { font-size: 0.85rem; color: var(--blue-btn); font-weight: 700; text-decoration: none; }

        /* --- MOBILE ADJUSTMENTS --- */
        @media (max-width: 600px) {
            header { height: 60px; }
            .container { margin: 15px auto; padding: 0 15px; }
            .noti-header { padding: 15px; }
            .noti-body { padding: 15px; font-size: 0.9rem; }
            .noti-footer { padding: 10px 15px; }
        }
    </style>
</head>
<body>
