    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; }
        ...
        body { 
            ...
            color: var(--text-dark); 
            font-size: 14px; 
            height: 100vh; /* Fixed height for 1-screen feel */
            overflow: hidden; 
        ...
        /* --- HEADER --- */
        header {
            background: var(--white); height: 50px; flex-shrink: 0;
            box-shadow: 0 2px 5px rgba(0,0,0,0.05);
            display: flex; align-items: center; z-index: 100;
        }
        .nav-wrapper { 
            width: 100%; max-width: 1150px; margin: 0 auto; padding: 0 15px; 
            display: flex; justify-content: space-between; align-items: center; 
        }
        .brand { display: flex; align-items: center; gap: 8px; color: var(--primary); font-weight: 800; font-size: 1.1rem; }
        .login-link { font-weight: 700; color: var(--primary); font-size: 0.9rem; text-decoration: none; }
        ...
        .signup-card {
            ...
            height: 100%; max-height: 600px; /* Fixed height container */
            border-radius: 16px;
        ...
        /* Animated Text */
        .visual-content h2 { 
            font-size: 2.2rem; font-weight: 800; margin-bottom: 15px; line-height: 1.2; 
        ...
        .form-header h1 { font-size: 1.8rem; font-weight: 800; color: var(--text-dark); margin-bottom: 2px; }
        .form-header p { color: #666; font-size: 0.9rem; }

        .form-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 15px; }
        .full-width { grid-column: span 2; }

        .input-label { display: block; font-weight: 600; font-size: 0.85rem; margin-bottom: 4px; color: #444; }
        
        .form-input, .form-select {
            width: 100%; padding: 8px 12px; border: 1px solid #ddd; border-radius: 8px;
            font-size: 0.95rem; outline: none; transition: 0.3s; background: #fff; height: 40px;
        }
        .form-input:focus { border-color: var(--primary); box-shadow: 0 0 0 2px rgba(72, 62, 168, 0.1); }

        .btn-submit {
            width: 100%; background: var(--primary); color: white; padding: 12px; 
            border-radius: 30px; font-size: 1rem; font-weight: 700; border: none;
            margin-top: 25px; transition: 0.3s; cursor: pointer;
        }
        .btn-submit:hover { background: #322b7a; }

        /* Animations */
        @keyframes floatBg { 0% { transform: scale(1); } 100% { transform: scale(1.1); } }
        @keyframes fadeInUp { from { opacity: 0; transform: translateY(20px); } to { opacity: 1; transform: translateY(0); } }

        /* --- MOBILE OPTIMIZATION (1 Screen) --- */
        @media (max-width: 900px) {
            body { height: 100vh; overflow: hidden; background: #fff; }
            header { height: 45px; border-bottom: 1px solid #eee; box-shadow: none; }
            .signup-section { padding: 0; height: calc(100vh - 45px); align-items: flex-start; }
            ...
            .form-side { padding: 15px 20px; justify-content: flex-start; }
            .form-header { margin-bottom: 15px; text-align: left; }
            ...
            .input-label { font-size: 0.75rem; margin-bottom: 2px; }
            .form-input, .form-select { height: 35px; font-size: 0.9rem; padding: 5px 10px; }
            
            /* Squeeze Grid: Designation & Contact on same row for Mobile */
            .mobile-half { grid-column: span 1 !important; }
            
            .btn-submit { margin-top: 15px; padding: 10px; }
        }
    </style>
</head>
<body>
