        ...
        <div class="container pricing-section">
            ...
            <div class="plans-grid">
                ...
                <?php foreach ($plans as $plan): ?>
                    ...
                    // Optional styling
                    $isRecommended = ($name == 'gold');
                    $cardClass = $isRecommended ? 'plan-card recommended' : 'plan-card';

                    // Color class
                    $colorClass = 'text-bronze';
                    if ($name == 'silver') $colorClass = 'text-silver';
                    if ($name == 'gold') $colorClass = 'text-gold';
                    ?>
                    ...
                    <div class="<?= $cardClass ?>">
                        ...
                        <div class="plan-header">
                            <span class="plan-name <?= $colorClass ?>">
                                <?= strtoupper($plan['plan_name']) ?>
                            </span>

                            <div class="plan-price">
                                ₹<?= number_format($plan['final_amount']) ?>
                                <small>/<?= $plan['validity_months'] ?> mo</small>
                            </div>

                            <span class="plan-duration">
                                <?= $plan['validity_months'] ?> Months Plan
                            </span>
                        </div>
