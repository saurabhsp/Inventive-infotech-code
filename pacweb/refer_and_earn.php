...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; }
        ...
        .nav-item { font-weight: 600; color: #555; font-size: 1rem; text-decoration: none; }
        .nav-right { display: flex; gap: 15px; align-items: center; }
        .login-link { font-weight: 700; color: var(--primary); text-decoration: none; }
        .btn-header-cta { background: var(--primary); color: white; padding: 8px 22px; border-radius: 30px; font-weight: 600; border: none; cursor: pointer; }
        ...
        .refer-card {
            ...
            overflow: hidden;
            display: grid;
            grid-template-columns: 400px 1fr; /* Fixed Visual Left, Content Right */
            min-height: 600px;
        }
        ...
        .gift-icon { font-size: 3rem; color: #FFD700; margin-bottom: 20px; animation: bounce 2s infinite; }
        .hero-title { font-size: 2.5rem; font-weight: 800; line-height: 1.1; margin-bottom: 15px; }
        .hero-desc { font-size: 1rem; opacity: 0.9; margin-bottom: 30px; }
        
        .stats-badge {
            display: inline-flex; align-items: center; gap: 10px;
            background: rgba(255,255,255,0.15); backdrop-filter: blur(5px);
            padding: 10px 15px; border-radius: 12px; font-weight: 600; font-size: 0.9rem;
            border: 1px solid rgba(255,255,255,0.2);
        }

        /* RIGHT PANEL: Content & Tools */
        .refer-content { padding: 40px 50px; overflow-y: auto; }

        /* Referral Link Box */
        .link-section { margin-bottom: 30px; }
        .section-label { font-size: 0.85rem; font-weight: 700; color: #888; text-transform: uppercase; margin-bottom: 8px; display: block; }
        
        .copy-box {
            display: flex; border: 1px solid #ddd; border-radius: 12px; padding: 5px;
            background: #fafafa;
        }
        .link-text { 
            flex: 1; border: none; background: transparent; padding: 10px 15px; 
            font-size: 1rem; color: #333; font-weight: 600; outline: none;
        }
        .btn-copy {
            background: var(--blue-copy); color: white; border: none;
            padding: 0 25px; border-radius: 8px; font-weight: 600; cursor: pointer; transition: 0.2s;
        }
        .btn-copy:hover { background: #0d47a1; }

        /* Buttons */
        .btn-whatsapp {
            width: 100%; background: var(--green-wa); color: white; border: none;
        ...
        .btn-qr:hover { background: #f5f5f5; }

        /* Steps */
        .how-title { text-align: center; font-size: 1.2rem; font-weight: 700; margin: 30px 0 20px; color: var(--primary); }
        
        .step-list { display: flex; flex-direction: column; gap: 15px; }
        .step-row { 
            display: flex; align-items: center; gap: 15px; 
            padding: 12px; border-radius: 12px; border: 1px solid #f0f0f0; background: white;
            transition: 0.2s;
        }
        .step-row:hover { box-shadow: 0 5px 15px rgba(0,0,0,0.03); border-color: var(--primary-light); }
        
        .step-icon { 
            width: 40px; height: 40px; border-radius: 50%; 
            display: flex; align-items: center; justify-content: center; font-size: 1.1rem;
            background: #f0f4ff; color: var(--blue-copy); flex-shrink: 0;
        }
        .step-info h4 { font-size: 0.95rem; font-weight: 700; margin-bottom: 2px; }
        .step-info p { font-size: 0.85rem; color: #666; margin: 0; }

        /* --- FOOTER --- */
        .mega-footer { background: #111; color: #bbb; padding: 50px 0 20px; }
        .footer-grid { width: 100%; max-width: 1150px; margin: 0 auto; display: grid; grid-template-columns: 2fr 1fr 1fr 1fr; gap: 30px; padding: 0 20px; }
        .f-brand h3 { color: white; margin-bottom: 10px; font-size: 1.3rem; }
        .f-links ul li { margin-bottom: 8px; font-size: 0.9rem; }
        ...
        @media (max-width: 900px) {
            ...
            .page-content { padding: 0; align-items: flex-start; }
            ...
            .hero-desc { font-size: 1rem; max-width: 300px; margin: 0 auto 20px; }
            .stats-badge { background: rgba(255,255,255,0.2); border: none; }

            /* 2. Mobile Content Card (Overlapping) */
            .refer-content { 
                background: white;
                margin-top: -40px; /* Negative margin creates overlap */
