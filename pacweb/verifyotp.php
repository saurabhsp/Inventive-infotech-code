...
// सुरक्षा: only allow valid values
if (!in_array($purpose, ['signup', 'forgot_password'])) {
    $purpose = 'signup';
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'verify_otp') {
    ...
    ========================= */
        ...
        /* =========================
       🔥 CASE 2: FORGOT PASSWORD (API ONLY)
            ========================= */ elseif ($purpose === 'forgot_password') {

            $api_url = API_BASE_URL . "verify_otp.php";
            // print_r( $api_url);
            // exit;
            ...
            if (curl_errno($ch)) {
                ...
                if ($result && isset($result['success']) && $result['success'] === true) {
                    ...
                    echo '<form id="redirectForm" method="POST" action="reset_password.php">
