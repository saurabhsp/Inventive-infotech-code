...
<div class="headbar">
  <div>
    <h1 class="page-title">Material Gate Pass Inward List</h1>
...
<div class="field">
<label>M.GatePass Inward No.</label>
...
<td>
  <div style="display:flex; gap:6px;">
    ...
    <?php if ($canEdit): ?>
      <form method="post" action="../operations/materialgatepass_inward.php" title="Edit">
    ...
    <!--</form>-->
           ...
           <!-- PRINT (POST to separate print file; do not implement print here) -->
                  <form method="post" action="salesorderprint.php" style="margin:0;" target="_blank">
