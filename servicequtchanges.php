...
function computeTotals(){
   ...
   * 5. PACKING
   * ----------------------------- */
  const packingBase = computeCharge(basicWithGST, 'packing_per', 'packing_amt');
   ...
   * 6. TRANSPORT
   * ----------------------------- */
  const transBase = computeCharge(basicWithGST, 'trans_per', 'trans_amt');
  ...
  const grandTotal = total5 + tcsAmt;
