...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!in_array($mode, ['list','filter','reset','delete'], true)) $mode = 'list';
}
      ...
      <div style="display:grid; grid-template-columns:repeat(6, minmax(0, 1fr)); gap:10px; align-items:end;">
        ...
        <div class="field" style="grid-column:3 / span 4;">
          ...
          <div style="display:flex; gap:8px; justify-content:flex-end; flex-wrap:wrap;">
            <button type="submit" class="btn success" style="padding:8px 12px;">Search</button>
            <button type="submit" class="btn secondary" style="padding:8px 12px;" name="mode" value="reset">Reset</button>
          </div>
        </div>
      </div>
    </form>
