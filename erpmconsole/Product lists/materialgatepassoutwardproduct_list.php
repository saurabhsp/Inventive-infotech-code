...
LEFT JOIN jos_ierp_gatepass_grid g 
    ON g.billid = s.id
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['export'] ?? '') === 'excel') {
    ...
    header("Content-Disposition: attachment; filename=mgatepass_out_products" . date('d-m-Y') . ".xls");
...
<div class="master-wrap">
    ...
    <div class="headbar">
        <div>
            <h1 class="page-title">Material Gate pass Outward Product List</h1>
    ...
    <div class="card" style="margin-top:12px;">
        <form method="post">
            ...
            <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:10px;align-items:end">
                ...
                <div class="field">
                    <label>M.GatePass Outward No. </label>
