...
if ($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['sale_form'])) {
    ...
    $plantid = (int)$_POST['plantname'];   // PLANT ID
...
//     $sitename,
//     $productIdMain,    // ✅ 1599
//     $productNameMain,  // ✅ "10 DEGREE IDLER BRACKET..."
//     $uid,
//     $uid,
//     $modifydate,
//     $yrid  
...
<input type="hidden" name="productid_main" id="productid_main">
<input type="hidden" name="product_main" id="product_main">
