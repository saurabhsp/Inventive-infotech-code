...
<head>
    <meta charset="utf-8">
    <title>Material Gatepass Outward Print</title>
...
<body>
    ...
    <div class="no-print" style="margin:10px;">
        ...
        <button class="btn btn-back" onclick="window.location.href='/reports/materialgatepassoutward_list.php'">Back</button>
    </div>
    ...
    <div class="print-wrapper">
        ...
        <table class="table">
            <tr>
                <th style="font-size:14px">Material Gate Pass Outward</th>
            </tr>
        </table>
        ...
        <table style="width:100%; border-collapse:collapse; margin-top:8px;">
            <tr>
                ...
                <td width="33%" style="vertical-align:top; padding:6px;">
                    ...
                    <div>
                        <strong>M.GatePass Outward No. :</strong>
